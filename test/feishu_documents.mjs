...
const documentRecords = [
  {
    ...
    selection_token: `${"b".repeat(24)}.${"d".repeat(96)}`,
    title: "已有的研究文档",
    type: "docx",
  ...
  },
  {
    ...
    request_id: null,
    selection_token: `${"c".repeat(24)}.${"e".repeat(96)}`,
    title: "飞书中原有的云文档",
    type: "docx",
...
await page.route(`${workerOrigin}/api/feishu/documents`, async (route) => {
  ...
  documentRecords.unshift({
    ...
    selection_token: `${createRequests.toString(16).padStart(24, "0")}.${createRequests.toString(16).padStart(96, "0")}`,
