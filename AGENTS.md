...
This repository is intentionally an empty bilingual site shell. The only public pages are Home, Projects, Research, Open Source, Notes, and About in Chinese and English. Do not add personal information, descriptions, posts, project records, research records, contact details, feeds, search, comments, analytics, CMS features, or decorative interactions unless the owner explicitly changes this scope.
